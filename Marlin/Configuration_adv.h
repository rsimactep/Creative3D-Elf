 ...
 *
 */
#define CONFIGURATION_ADV_H_VERSION 020101
...
//#define MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED 5 //for DyzEnd 450 termistor
...
//#define MILLISECONDS_PREHEAT_TIME 30000 // for DyzEnd 450 termistor
...
#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH 0.6 //3                // (mm) Default retract length (positive value)
  ...
  #define RETRACT_RECOVER_FEEDRATE 45 //8      // (mm/s) Default feedrate for recovering from retraction
  #define RETRACT_RECOVER_FEEDRATE_SWAP 0 //8 // (mm/s) Default feedrate for recovering from swap retraction
...
#define USE_WIFI_FUNCTION		1 // Enable wifi configuration in UI															   
